...
//       // Si des résultats de recherche sont passés, on les utilise directement
//       setRecipes(location.state.results);
//     } else {
//       // Sinon, on continue avec la logique habituelle
//       fetchRecipes(selectedCategory, page);
//     }
//   }, [location, selectedCategory, page]);
...
//   useEffect(() => {
//     if (!location.state?.results) {
//       // On ne déclenche la recherche que si les résultats de recherche ne sont pas passés
//       fetchRecipes(selectedCategory, page);
//     }
//   }, [selectedCategory, page, fetchRecipes, location.state?.results]);
