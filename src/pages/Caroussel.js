...
const Carousel = ({ category, apiKey }) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch(`https://api.spoonacular.com/recipes/random?number=5&tags=${category}&apiKey=${apiKey}`);
